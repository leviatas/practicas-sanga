...
export const grade1Practices: Practice[] = [
  ...
  // --------------------------------------------------------- Prepositions ----
  {
    id: 'preposiciones',
    title: 'Preposiciones',
    description: 'Mirá el dibujo y completá con in, on, under o next to.',
    emoji: '📦',
    questions: [
      { id: 'p1', prompt: 'The cat is sleeping here: 🛏️🐱 (on top). The cat is ___ the bed.',
        options: [{ text: 'on', correct: true }, { text: 'under' }, { text: 'in' }] },
      { id: 'p2', prompt: 'The ball is here: 🪑\n⚽ (below). The ball is ___ the chair.',
        options: [{ text: 'under', correct: true }, { text: 'on' }, { text: 'next to' }] },
      { id: 'p3', prompt: 'The toy is here: 📦🧸 (inside). The toy is ___ the box.',
        options: [{ text: 'in', correct: true }, { text: 'on' }, { text: 'under' }] },
      { id: 'p4', prompt: 'The dog is here: 🏠🐶 (beside). The dog is ___ the house.',
        options: [{ text: 'next to', correct: true }, { text: 'in' }, { text: 'on' }] },
    ],
  },
