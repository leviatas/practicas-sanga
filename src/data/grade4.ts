...
export const grade4Practices: Practice[] = [
  ...
  // ----------------------------------------------------------- Giving directions ----
  {
    id: 'direcciones',
    title: 'Direcciones',
    description: 'Giving directions in English.',
    emoji: '🧭',
    questions: [
      { id: 'd1', prompt: 'To go the opposite way of "turn right", you...',
        options: [{ text: 'turn left', correct: true }, { text: 'go straight on' }, { text: 'go past' }] },
      { id: 'd2', prompt: 'The bank is there. Go straight on and it’s ___ the right.',
        options: [{ text: 'on', correct: true }, { text: 'in' }, { text: 'at' }] },
      { id: 'd3', prompt: 'Do not stop and do not turn. You...',
        options: [{ text: 'go straight on', correct: true }, { text: 'turn left' }, { text: 'turn right' }] },
    ],
  },
